...
class AmazonLogInTC(unittest.TestCase):
    ...
    def test_login(self):
        ...
        searchButton = self.driver.find_element(By.ID, "nav-search-submit-button")
        searchButton.click()
        imageSection = self.driver.find_element(By.LINK_TEXT, "Images")
        imageSection.click()
        cartButton = self.driver.find_element(By.ID, "add-to-cart-button")
        cartButton.click()
